...
function loadDefaults() {
  ...
  */
  jQuery("#dropDownColumn_0_1 .uploadFormTitle").append(`<a id="save-default-orientation" style="color:#ff0000;font-size:12px;float:right;">Save default</a>`);
  ...
  jQuery('#save-default-orientation').click(function(){
    var orientation = jQuery('#dropDownTitle_0_1').text().trim();
    var orientationId;
    switch(orientation) {
      case "Straight":
      orientationId = 1;
   ...
   */
  jQuery("#dropDownColumn_2_1 .uploadFormTitle").append(`<a id="save-default-production" style="color:#ff0000;font-size:12px;float:right;">Save default</a>`);
  // Select default on page load.
  ...
  jQuery('#save-default-production').click(function(){
    var production = jQuery('#dropDownTitle_2_1').text().trim().toLowerCase();
   ...
   */
  jQuery("#dropDownColumn_3_1 .uploadFormTitle").append(`<a id="save-default-privacy" style="color:#ff0000;font-size:12px;float:right;">Save default</a>`);
  // Select default on page load.
  ...
  jQuery('#save-default-privacy').click(function(){
    var privacy = jQuery('#dropDownTitle_3_1').text().trim().toLowerCase();
   ...
   * Values: <many>
   */
  jQuery("#dropDownColumn_4_1 .uploadFormTitle").append(`<a id="save-default-language" style="color:#ff0000;font-size:12px;float:right;">Save default</a>`);
  // Select default on page load.
  ...
  jQuery('#save-default-language').click(function(){
    var language = jQuery('#dropDownTitle_4_1').text().trim();
    switch (language) {
      case "English":
        var languageId = 0;
        break;
